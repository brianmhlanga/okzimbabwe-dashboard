                    ...
                    <div>
                        ...
                        <div class="grid formgrid p-fluid">
                            ...
                            <div class="field mb-4 col-12 md:col-12"> 
                                <DataTable :value="users" ref="dt"  class="p-datatable-customers" showGridlines :rows="10"
                            ...
                            >
                                    ...
                                    <Column frozen  field="description" header="Email" style="min-width:12rem">
                                        <template #body="{data}">
                                            {{data.email}}
                                        </template>
                                    </Column>
                                    <Column frozen  field="category.name" header="Whatsapp number " style="min-width:12rem">
                                        <template #body="{data}">
                                            {{data.whatsapp_number? data.whatsapp_number: 'Not Set'}}
                                        </template>
                                    </Column>
                                    <Column frozen  field="category.name" header="Contact number " style="min-width:12rem">
                                        <template #body="{data}">
                                            {{data.contact_number? data.contact_number: 'Not Set'}}
                                        </template>
                                    </Column>
                                    <Column frozen  field="category.name" header="Type" style="min-width:12rem">
                                        <template #body="{data}">
                                            {{data.type}}
                                        </template>
                                    </Column>
  ...
  return null; // Return null if parsing fails or no images are found
    ...
    const clearFilter1 = () => {
     ...
     onMounted(async () => {
        ...
        shopBrandsStore.getUsers().then((data:any)=>{
