       ...
       <section class="section">
                    ...
                    <div>
                        ...
                        <div class="grid formgrid p-fluid">
                            ...
                            >
                                    ...
                                    <!-- <Column frozen  field="category.name" header="Unit of Measure " style="min-width:12rem">
                                        <template #body="{data}">
        ...
        <Dialog v-model:visible="addLineItem" maximizable modal header="Create Product" position="top" :style="{ width: '55vw' }">
                <div class="grid formgrid p-fluid">
                    ...
                    <div class="field mb-4 col-12 md:col-12">
                        <label for="company_name" class="font-medium text-900">Select Unit of Measure</label> 
                        <div class="flex flex-wrap gap-8 ">
                            <div class="flex align-items-center">
                                <RadioButton v-model="unit_of_measure" inputId="ingredient2" name="pizza" value="Each" />
                                <label for="ingredient2" class="ml-2">Each</label>
                            </div>
                            <div class="flex align-items-center">
                                <RadioButton v-model="unit_of_measure" inputId="ingredient3" name="pizza" value="Case" />
                                <label for="ingredient3" class="ml-2">Case</label>
                            </div>
                        </div>
                    </div>
                    <div class="field mb-4 col-12 md:col-12"> 
