    ...
    <NuxtLayout name="dashboard">
        <section class="section">
            <div class="container-fluid pt-3">
                ...
                <div ><Button @click="getFeaturedProduct()" label="Get Featured Product" icon="pi pi-plus" /></div>

                    
                           
                             <div  class="field mb-4 col-12 md:col-12"> 
                                <DataTable :value="featured_product_list" ref="dt" class="p-datatable-customers" showGridlines :rows="10"
...
const getFeaturedProduct = async () => {
    ...
    const data = {
        id: referenced_id.value,
      
    };
    const info = {
        is_shop_brand:shop_brand.value
    }
    console.log('is shop brand',shop_brand.value)
    const result:any = await shopBrandsStore.get_all_featured_products(referenced_id.value,shop_brand.value);
    featured_product_list.value = result.data.data.products
    console.log('ddb',result.data.data.products)
