    ...
    <NuxtLayout name="dashboard">
       <section class="section">
            <div class="container-fluid pt-3">
                <div class="row">
                    <div class="text-900 font-medium text-xl mb-3">Shopping Carts</div>
                    <div>
                        <div class="card p-4 ">
                        <div class="grid formgrid p-fluid">
                            <div class="field mb-4 col-12 md:col-12"> 
                                <DataTable :value="carts" ref="dt"  class="p-datatable-customers" showGridlines :rows="10"
                            ...
                            >
                                    ...
                                    <Column frozen  field="category.name" header="Cart Total" style="min-width:12rem">
                                        <template #body="{data}">
                                            {{data.cart_total}}
                                        </template>
                                    </Column>
                                    <Column frozen  field="category.name" header="Shop name " style="min-width:12rem">
                                        <template #body="{data}">
                                            {{data.shop.name}}
                                        </template>
                                    </Column>
  ...
  return null; // Return null if parsing fails or no images are found
    ...
    const clearFilter1 = () => {
     ...
     onMounted(async () => {
        ...
        shopBrandsStore.getShoppingCart().then((data:any)=>{
            carts.value = data.data.data.data
            console.log('user',carts.value)
        })
